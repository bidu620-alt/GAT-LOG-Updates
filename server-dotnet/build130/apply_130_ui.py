...
s=s.replace('CurrentVersion = "1.0.0"','CurrentVersion = "1.0.30"')
s=s.replace('GAT-LOG SERVER 1.0 | ETS2 + Telemetria','GAT-LOG SERVER 1.0.30 | ETS2 + Telemetria')
s=s.replace('C# WinForms 1.0.0','C# WinForms 1.0.30')
...
p=p.replace('<Version>1.0.0.0</Version>','<Version>1.0.30.0</Version>')
p=p.replace('<FileVersion>1.0.0.0</FileVersion>','<FileVersion>1.0.30.0</FileVersion>')
p=p.replace('<AssemblyVersion>1.0.0.0</AssemblyVersion>','<AssemblyVersion>1.0.30.0</AssemblyVersion>')
...
x=x.replace('Instalar GAT-LOG Server C# 1.0.0 TESTE?','Atualizar GAT-LOG Server C# para 1.0.30?')
x=x.replace('GAT-LOG Server C# 1.0.0 TESTE instalado.','GAT-LOG Server C# 1.0.30 atualizado.')
...
q=q.replace('GAT_LOG_SERVER_DOTNET_SETUP_1.0.0_TESTE','GAT_LOG_SERVER_DOTNET_UPDATE_1.0.30_TESTE')
...
print('UI/updater 1.0.30 preparado')
