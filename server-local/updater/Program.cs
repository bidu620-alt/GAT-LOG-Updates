...
{
    const string PackageUrl="https://raw.githubusercontent.com/bidu620-alt/GAT-LOG-Updates/main/releases/GAT_SERVER_LOCAL_1.0.46.zip";
    ...
    Updater(){Text="GAT Servidor 1.0.46 - meta mensal por viagens validas";ClientSize=new Size(590,160);StartPosition=FormStartPosition.CenterScreen;Controls.Add(status);Shown+=async(s,e)=>await Install();}
    ...
    async Task Install(){
        ...
        try{
            ...
            if(version!="1.0.39.0"&&version!="1.0.40.0"&&version!="1.0.41.0"&&version!="1.0.42.0"&&version!="1.0.43.0"&&version!="1.0.44.0"&&version!="1.0.45.0"&&version!="1.0.46.0")throw new InvalidOperationException("Esta atualizacao foi preparada para as versoes 1.0.39 a 1.0.46. Versao encontrada: "+version);
            ...
            status.Text="Instalando Central 1.0.46 e reconciliando a meta 30/30...";
            ...
            MessageBox.Show(this,"GAT Servidor 1.0.46 instalado.\r\nA meta mensal agora conta viagens validas imediatamente, mesmo quando a carga ainda aguarda classificacao.\r\nA classificacao posterior nao soma a mesma viagem de novo.\r\nO progresso mensal e reconciliado pelas entregas validas ja salvas, entao a entrega feita na 1.0.45 e preservada.\r\nO ranking continua sem distancia minima durante os testes.\r\nBanco, pontos, entregas, contas, senhas e PCs vinculados foram preservados.","Atualizacao concluida",MessageBoxButtons.OK,MessageBoxIcon.Information);Close();
        }catch(Exception ex){
