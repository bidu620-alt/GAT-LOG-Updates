...
{
    const string PackageUrl="https://raw.githubusercontent.com/bidu620-alt/GAT-LOG-Updates/main/releases/GAT_SERVER_LOCAL_1.0.41.zip";
    ...
    Updater(){Text="GAT Servidor 1.0.41 - inicio oficial";ClientSize=new Size(590,160);StartPosition=FormStartPosition.CenterScreen;Controls.Add(status);Shown+=async(s,e)=>await Install();}
    ...
    async Task Install(){
        ...
        try{
            ...
            if(version!="1.0.39.0"&&version!="1.0.40.0"&&version!="1.0.41.0")throw new InvalidOperationException("Esta atualizacao foi preparada para as versoes 1.0.39, 1.0.40 ou 1.0.41. Versao encontrada: "+version);
            ...
            status.Text="Instalando Central 1.0.41 e preparando o inicio oficial...";
            ...
            MessageBox.Show(this,"GAT Servidor 1.0.41 instalado.\r\nFoi preservada uma copia do banco antes da atualizacao.\r\nNo primeiro inicio, ranking, XP, KM e cargas de teste sao zerados uma unica vez.\r\nContas, senhas, PCs vinculados, papeis, catalogo e configuracoes permanecem.","Atualizacao concluida",MessageBoxButtons.OK,MessageBoxIcon.Information);Close();
        }catch(Exception ex){
