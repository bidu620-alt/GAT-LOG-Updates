...
{
    const string PackageUrl="https://raw.githubusercontent.com/bidu620-alt/GAT-LOG-Updates/main/releases/GAT_SERVER_LOCAL_1.0.51.zip";
    ...
    Updater(){Text="GAT Servidor 1.0.51 - viagens persistentes";ClientSize=new Size(590,160);StartPosition=FormStartPosition.CenterScreen;Controls.Add(status);Shown+=async(s,e)=>await Install();}
    ...
    async Task Install(){
        ...
        try{
            ...
            if(version!="1.0.39.0"&&version!="1.0.40.0"&&version!="1.0.41.0"&&version!="1.0.42.0"&&version!="1.0.43.0"&&version!="1.0.44.0"&&version!="1.0.45.0"&&version!="1.0.46.0"&&version!="1.0.47.0"&&version!="1.0.48.0"&&version!="1.0.49.0"&&version!="1.0.50.0"&&version!="1.0.51.0")throw new InvalidOperationException("Esta atualizacao foi preparada para as versoes 1.0.39 a 1.0.51. Versao encontrada: "+version);
            ...
            status.Text="Instalando Central 1.0.51 e ativando retomada de viagens...";
            ...
            MessageBox.Show(this,"GAT Servidor 1.0.51 instalado.\r\n\r\nViagens abertas agora ficam persistidas na Central e podem ser retomadas depois de fechar o app, fechar o jogo, reiniciar o PC, perder internet ou alternar entre ETS2/ATS e mapas diferentes. Um novo ID gerado pelo aplicativo pode ser reconciliado com a mesma viagem pela identidade da carga.\r\n\r\nO ranking continua exigindo telemetria e dados de danos validos, mas pacotes transitorios e uma retomada normal nao condenam permanentemente uma viagem ja verificada.\r\n\r\nA entrega da Pa-carregadeira do EduardoVidal e reparada automaticamente com as evidencias ja salvas: 95/100 Pontos GAT.\r\n\r\nBanco, historico, pontos, entregas, contas, senhas e PCs vinculados foram preservados.","Atualizacao concluida",MessageBoxButtons.OK,MessageBoxIcon.Information);Close();
        }catch(Exception ex){
