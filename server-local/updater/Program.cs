...
internal class Updater : Form
{
    ...
    Updater(){Text="GAT Servidor 1.0.55 - carga aberta";ClientSize=new Size(620,170);StartPosition=FormStartPosition.CenterScreen;Controls.Add(status);Shown+=async(s,e)=>await Install();}
    ...
    async Task Install(){
        ...
        try{
            ...
            status.Text="Instalando Central 1.0.55 e liberando carga aberta...";
            ...
            MessageBox.Show(this,"GAT Servidor 1.0.55 instalado.\r\n\r\nA Central nao rejeita mais carga por nome, categoria ou compatibilidade e nao envia cargas novas para classificacao. Qualquer carga detectada pela telemetria, inclusive cargas de mods e mapas, e registrada no historico e segue as regras normais da viagem e do ranking.\r\n\r\nAs correcoes 1.0.53 e 1.0.54, incluindo estabilidade do status online, recibos, checkpoints e caixa-preta assinada do GAT Telemetria 1.0.32, continuam incluidas. Banco, historico, pontos, entregas, contas, senhas, PCs vinculados e viagens abertas foram preservados.","Atualizacao concluida",MessageBoxButtons.OK,MessageBoxIcon.Information);Close();
        }catch(Exception ex){
