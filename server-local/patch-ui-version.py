...
for old_line,new_line in [
    ('AssemblyFileVersion("1.0.48.0")','AssemblyFileVersion("1.0.55.0")'),
    ('AssemblyInformationalVersion("1.0.48.0+jeanjc-rank-repair")','AssemblyInformationalVersion("1.0.55.0+open-cargo")'),
    ('AssemblyVersion("1.0.48.0")','AssemblyVersion("1.0.55.0")'),
]:
