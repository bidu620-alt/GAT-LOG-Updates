...
replacements=[
    ...
    ("const VERSION='1.0.40-local'","const VERSION='1.0.45-local'")
]
...
required=["const adminTest=false;","const VERSION='1.0.45-local'","const MIN_KM=0;"]
for marker in required:
    if marker not in s:
        raise SystemExit('Central 1.0.45 nao foi preparada corretamente: '+marker)

p.write_text(s,encoding='utf-8')
print('Go-live 1.0.45: sem minimo de km e com janela segura para os danos no primeiro pacote.')
