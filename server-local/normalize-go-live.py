...
replacements=[
    ...
    ("const VERSION='1.0.40-local'","const VERSION='1.0.48-local'")
]
...
required=["const adminTest=false;","const VERSION='1.0.48-local'","const MIN_KM=0;"]
for marker in required:
    if marker not in s:
        raise SystemExit('Central 1.0.48 nao foi preparada corretamente: '+marker)

p.write_text(s,encoding='utf-8')
print('Go-live 1.0.48: prova pre-carga de danos; reparo JeanJC; sem minimo de km.')