(()=>{
  ...
  function loadEnhancements(){loadScript('gatMotoristaEnhancements','motorista-enhancements.js?v=4');loadScript('gatMotoristaNavFix','motorista-nav-fix.js?v=2');loadScript('gatMotoristaInfractions','motorista-infractions.js?v=3');loadScript('gatDriverGamification','driver-gamification.js?v=3');loadScript('gatSecretConquest','secret-conquest.js?v=1');loadScript('gatOfficialWorkRules','official-work-rules.js?v=5');loadScript('gatRegisteredCargoLite','work-cargo-registered-lite.js?v=2');loadScript('gatDeliveryRefreshLite','delivery-refresh-lite.js?v=1')}
